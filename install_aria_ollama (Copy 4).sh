...
<body data-state="idle" data-theme="light">
        ...
        <div class="hero-card">
          ...
          <div class="status-grid">
            <div class="stat">
              ...
              <div id="wakeState" class="stat-value voice-state"><i data-lucide="power"></i><span>Ready</span></div>
            </div>
          </div>
        </div>
  ...
  <script>
    ...
    function setVoiceMode(text) {
      wakeStateEl.innerHTML = `<i data-lucide="power"></i><span>${escapeHtml(text)}</span>`;
      refreshLucide();
    }
