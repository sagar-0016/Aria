...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .chat-shell:hover::-webkit-scrollbar,
    .chat-shell:focus-within::-webkit-scrollbar,
    ...
    body[data-theme="dark"] .chat-shell:hover,
    body[data-theme="dark"] .chat-shell:focus-within,
    ...
    body[data-theme="dark"] .chat-shell::-webkit-scrollbar-track,
    body[data-theme="dark"] .modal::-webkit-scrollbar-track {
      background: rgba(255, 255, 255, 0.05);
    }
    body[data-theme="dark"] .chat-shell::-webkit-scrollbar-thumb,
    ...
    body[data-theme="dark"] .chat-shell::-webkit-scrollbar-thumb:hover,
...
<body data-state="idle" data-theme="light">
            ...
            <div class="hero-card">
              ...
              <div class="status-grid">
                <div class="stat">
                  ...
                  <div id="wakeState" class="stat-value voice-state"><span>Ready</span></div>
                </div>
              </div>
            </div>
  ...
  <script>
    ...
    function renderControlIcons() {
      ...
      chatDrawerCloseBtn.innerHTML = '<i data-lucide="x"></i>';
    ...
    chatDrawerCloseBtn.onclick = () => setChatOpen(false);
